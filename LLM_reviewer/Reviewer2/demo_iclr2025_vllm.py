...
MIN_ENGINE_MAX_MODEL_LEN = 32768
DEFAULT_ENGINE_MAX_MODEL_LEN = 38912
...
def parse_args():
    parser = argparse.ArgumentParser(description="Reviewer2 ICLR2025 vLLM Batch Processing")
    parser.add_argument(
        "--grobid_dir",
        type=str,
...
def main():
    ...
    input_files = sorted(glob.glob(str(grobid_dir / "*.grobid.txt")))
    ...
    for file_path in input_files:
        ...
        if (
            output_path.exists()
            and review_file_has_content(output_path)
    ...
    print("\n" + "=" * 70)
    print("ICLR2025 BATCH PROCESSING COMPLETE")
    print("=" * 70)
