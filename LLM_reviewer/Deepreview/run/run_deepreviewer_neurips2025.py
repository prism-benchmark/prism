...
Usage:
    ...
    python run_deepreviewer_neurips2025.py --check          # check environment only
    python run_deepreviewer_neurips2025.py --limit 2        # only process first 2 papers (for testing)
"""
...
# ── Load config ───────────────────────────────────────────────
try:
    import deepreviewer_config_neurips2025 as deepreviewer_config
except ImportError:
    print("ERROR: deepreviewer_config_neurips2025.py not found. Must be in the same directory.")
    sys.exit(1)
