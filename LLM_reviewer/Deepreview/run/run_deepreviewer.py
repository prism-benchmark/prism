...
# ── Load config ───────────────────────────────────────────────
try:
    import deepreviewer_config
except ImportError:
    print("ERROR: deepreviewer_config.py not found. Must be in the same directory.")
    sys.exit(1)
