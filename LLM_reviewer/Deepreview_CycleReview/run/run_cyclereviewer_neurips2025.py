"""
CycleReviewer-ML-Llama-3.1-8B Pipeline for NeurIPS2025
Uses the official ai_researcher package.

Usage:
    python run_cyclereviewer_neurips2025.py --check     # environment check only
    python run_cyclereviewer_neurips2025.py --limit 2   # test run
    python run_cyclereviewer_neurips2025.py --all-papers # process all papers
    python run_cyclereviewer_neurips2025.py             # full run (200 papers from subset)
"""
...
from cyclereviewer_config_neurips2025 import (
    MODEL_SIZE, GPU_ID,
...
def check_environment():
    print("=== NeurIPS2025 CycleReviewer Environment Check ===")
    ok = True
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="CycleReviewer pipeline for NeurIPS2025 dataset"
    )
