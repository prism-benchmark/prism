...
PAPER_IDS_FILE      = os.getenv("CYCLEREVIEWER_PAPER_IDS_FILE", os.path.join(DATA_ROOT, "NeurIPS2025", "data_subset", "paper_ids.txt"))

# ── OUTPUT ────────────────────────────────────────────────────────────────────
OUTPUT_FOLDER       = os.getenv("CYCLEREVIEWER_OUTPUT_FOLDER", "outputs/cyclereview_neurips2025")
SUMMARY_FILE        = os.getenv("CYCLEREVIEWER_SUMMARY_FILE", "outputs/summary_cyclereview_neurips2025.json")
SKIP_COMPLETED      = True
