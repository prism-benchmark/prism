"""
Flaw-Identification Pipeline – ICLR 2026 entry point (Mimo v2.5 Pro).

Data paths  : E:\\Final_LLM_Reviewer_Data\\ICLR2026\\
Default LLM : Mimo v2.5 Pro  (OpenAI-compatible API)
Paper IDs   : paper_ids_50_iclr2026.txt  (50-paper subset)
...
Example commands
----------------
  python main_cfi_iclr2026_mimo.py --mode cfi_only
  python main_cfi_iclr2026_mimo.py --mode all
  python main_cfi_iclr2026_mimo.py --mode cps_only
  python main_cfi_iclr2026_mimo.py --mode cfi_only --llm-type deepreview
"""
...
TREE_FOLDER        = os.path.join(ICLR2026_DATA, "tree_iclr2026")
...
PAPER_IDS_FILE     = os.path.join(ICLR2026_DATA, "paper_ids_50_iclr2026.txt")
OUTPUT_DIR         = os.path.join(_HERE, "output_cfi_iclr2026_mimo")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run flaw-identification pipeline on ICLR 2026 data (Mimo).",
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "  tree        – Tree reviews from tree_iclr2026_2/\n"
