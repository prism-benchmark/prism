...
Example commands
----------------
  python main_cfi_icml2025_mimo.py --mode cfi_only
  python main_cfi_icml2025_mimo.py --mode all
  python main_cfi_icml2025_mimo.py --mode cps_only
  python main_cfi_icml2025_mimo.py --mode cfi_only --llm-type deepreview
"""
...
TREE_FOLDER        = os.path.join(ICML2025_DATA, "tree_icml2025")
...
PAPER_IDS_FILE     = os.path.join(ICML2025_DATA, "paper_ids_50_icml2025.txt")
OUTPUT_DIR         = os.path.join(_HERE, "output_cfi_icml2025_mimo")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run flaw-identification pipeline on ICML 2025 data (Mimo).",
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "  tree        – Tree reviews from tree_icml2025_2/\n"
