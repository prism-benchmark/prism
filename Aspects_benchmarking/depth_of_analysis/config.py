...
LLM_SOURCES = {
    ...
    "tree_iclr2026_2":   {"dir": _p("ICLR2026",    "tree_iclr2026_2"),   "format": "tree_json"},
    "tree_icml2025":     {"dir": _p("ICML2025",    "tree_icml2025"),     "format": "tree_json"},
    "tree_icml2025_2":   {"dir": _p("ICML2025",    "tree_icml2025_2"),   "format": "tree_json"},
    "tree_neurips2025":  {"dir": _p("NeurIPS2025", "tree_neurips2025"),  "format": "tree_json"},
    "tree_neurips2025_2":{"dir": _p("NeurIPS2025", "tree_neurips2025_2"),"format": "tree_json"},

    # ── Reviewer2 ────────────────────────────────────────────────────────
    "reviewer2_iclr2024":    {"dir": _p("ICLR2024",    "reviewer2_iclr2024"),    "format": "reviewer2_txt"},
    "reviewer2_iclr2025":    {"dir": _p("ICLR2025",    "reviewer2_iclr2025"),    "format": "reviewer2_txt"},
    "reviewer2_iclr2026":    {"dir": _p("ICLR2026",    "reviewer2_iclr2026"),    "format": "reviewer2_txt"},
    "reviewer2_icml2025":    {"dir": _p("ICML2025",    "reviewer2_icml2025"),    "format": "reviewer2_txt"},
    "reviewer2_neurips2025": {"dir": _p("NeurIPS2025", "reviewer2_neurips2025"), "format": "reviewer2_txt"},

    # ── DeepReview ───────────────────────────────────────────────────────
    "deepreview_iclr2024":    {"dir": _p("ICLR2024",    "deepreview_iclr2024"),    "format": "deepreview_json"},
    "deepreview_iclr2025":    {"dir": _p("ICLR2025",    "deepreview_iclr2025"),    "format": "deepreview_json"},
    "deepreview_iclr2026":    {"dir": _p("ICLR2026",    "deepreview_iclr2026"),    "format": "deepreview_json"},
    "deepreview_icml2025":    {"dir": _p("ICML2025",    "deepreview_icml2025"),    "format": "deepreview_json"},
    "deepreview_neurips2025": {"dir": _p("NeurIPS2025", "deepreview_neurips2025"), "format": "deepreview_json"},

    # ── CycleReview ──────────────────────────────────────────────────────
    "cyclereview_iclr2024":    {"dir": _p("ICLR2024",    "cyclereview_iclr2024"),    "format": "cyclereview_json"},
    "cyclereview_iclr2025":    {"dir": _p("ICLR2025",    "cyclereview_iclr2025"),    "format": "cyclereview_json"},
    "cyclereview_iclr2026":    {"dir": _p("ICLR2026",    "cyclereview_iclr2026"),    "format": "cyclereview_json"},
    "cyclereview_icml2025":    {"dir": _p("ICML2025",    "cyclereview_icml2025"),    "format": "cyclereview_json"},
    "cyclereview_neurlps2025": {"dir": _p("NeurIPS2025", "cyclereview_neurlps2025"), "format": "cyclereview_json"},
}
...
def get_mimo_output_dir(source_name: str) -> str:
    return os.path.join(OUTPUT_ROOT, f"mimo_{source_name}")

# ── Paper IDs (50-paper subset per conference) ────────────────────────────
PAPER_IDS_50_BY_CONFERENCE = {
    conf: paper_ids_file(conf, 50) for conf in
